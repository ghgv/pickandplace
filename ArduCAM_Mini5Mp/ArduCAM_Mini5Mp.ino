...
/*const char bmp_header[BMPIMAGEOFFSET] PROGMEM =
{
  ...
  0x00, 0x00, 0x40, 0x01, 0x00, 0x00, 0xF0, 0x00, 0x00, 0x00, 0x01, 0x00, 0x18, 0x00, 0x03, 0x00,
...
if (Serial.available())
{
  ...
  {
    case 0:
      myCAM.OV5642_set_JPEG_size(OV5642_320x240);delay(2000);
...
else if (mode == 3)
{
  ...
  if (myCAM.get_bit(ARDUCHIP_TRIG, CAP_DONE_MASK))
  {
    Serial.println(F("ACK CMD CAM Capture Doneg. END"));
    delay(50);
